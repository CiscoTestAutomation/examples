...
Verify Ping from helper to uut
    run testcase    pyats_loopback_reachability.NxosPingTestcase    device=helper
...
Verify the counts of 'up' Interace for uut&helper
    verify count "18" "interface up" on device "uut"
    verify count "18" "interface up" on device "helper"
...
verify Bgp summary before trigger UnconfigureBgpNeighbor
    Run verification "Verify_BgpAllSummary" on device "uut"
