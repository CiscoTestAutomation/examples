...
Verify Ping from uut to helper
    run testcase    pyats_loopback_reachability.NxosPingTestcase    device=uut
...
verify Bgp summary before trigger UnconfigureBgpNeighbor
    Run verification "Verify_BgpVrfAllAllSummary" on device "uut"
verify Bgp neighbors before trigger UnconfigureBgpNeighbor
    Run verification "Verify_BgpVrfAllNeighbors_vrf_default" on device "uut"
...
Verify the counts of Bgp 'established' neighbors for uut&helper is deleted by 1 
    verify count "0" "bgp neighbors" on device "uut"
    verify count "0" "bgp neighbors" on device "helper"
...
Trigger ShutNoShutBgpNeighbors
    Run trigger "TriggerShutNoShutBgpNeighbors" on device "uut" using alias "cli"


# ---------  Global verifications 3 -----------
verify Bgp summary after GENIE trigger ShutNoShutBgpNeighbors
    Run verification "Verify_BgpVrfAllAllSummary" on device "uut"
verify Bgp neighbors after GENIE trigger ShutNoShutBgpNeighbors
    Run verification "Verify_BgpVrfAllNeighbors_vrf_default" on device "uut"
