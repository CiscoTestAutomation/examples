...
GigabitEthernet1 is up, line protocol is up 
  Hardware is CSR vNIC, address is 5254.0083.fc9b (bia 5254.0083.fc9b)
  ...
  Last input 00:00:15, output 00:00:41, output hang never
  ...
  5 minute output rate 0 bits/sec, 0 packets/sec
     6 packets input, 2133 bytes, 0 no buffer
...
attrValPairsToParse = [
    ('show.intf.if_name',                       'GigabitEthernet1'),
]
...
pgfill = oper_fill (
    dev1,
    ('show_interface_<WORD>', [], {'ifname':'GigabitEthernet1'}),
    attrValPairsToParse,
